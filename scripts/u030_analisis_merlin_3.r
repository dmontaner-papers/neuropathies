...
##TRABAJAMOS CON LOS DOS afectados MISSING corregidos segun las indicaciones de Eduardo
## Si recuerdas, teníamos en duda el estatus de 2 indivuduos de la familia. Los individuos 724 y 726.
## Ya están claros, y con ello ya tenos por fin claro todo. El 724 es ENFERMO y el 726 es SANO.
...
setwd (file.path (.job$datadir, "data_processed", "merlin_3"))
